...
pub trait ProfileRepositoryTrait<T: TransactionTrait>: Send + Sync {
    ...
    async fn find_by_id(&self, transaction: Option<&mut T>, profile_id: i64) -> Result<Profile, RepositoryError>;
    async fn find_by_user_id(&self, transaction: Option<&mut T>, user_id: i64) -> Result<Profile, RepositoryError>;
    async fn update_profile_by_id(&self, transaction: Option<&mut T>, profile_id: i64, display_name: Option<String>, bio: Option<String>) -> Result<(), RepositoryError>;
